...
- #### products
  ...
  products are used to generated blog products, news articles, or any other type of content that is published over time. All products are layout builder enabled so you can generate unique layouts for each post using layout-building blocks, see [Layout Builder](#layout-builder) for more details. products are also draft-enabled so you can preview them before publishing them to your website, see [Draft Preview](#draft-preview) for more details.
...
- #### Media
  ...
  This is the uploads enabled collection used by pages, products, and projects to contain media like images, videos, downloads, and other assets.

- #### Categories

  A taxonomy used to group products together. Categories can be nested inside of one another, for example "News > Technology". See the official [Payload Nested Docs Plugin](https://payloadcms.com/docs/beta/plugins/nested-docs) for more details.
...
- `products`: Everyone can access published products, but only users can create, update, or delete them.
...
To spin up this example locally, follow the [Quick Start](#quick-start). Then [Seed](#seed) the database with a few pages, products, and projects.
...
To seed the database with a few pages, products, and projects you can click the 'seed database' link from the admin panel.
